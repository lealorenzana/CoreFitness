...
## Roadmap
**0001–0086 are live; 0087 (goals settle themselves) and 0088 (coach notes seen/done) await pasting.** Verify with `python scripts/probe-migrations.py` (REST, no DB credentials)
