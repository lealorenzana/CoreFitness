...
## Roadmap
**0001–0091 are live; 0092 (reward decide/hand-over, saving-for) awaits pasting.** `lib/memberDataExport.ts` is identical in both apps. Verify with `python scripts/probe-migrations.py` (REST, no DB credentials)
