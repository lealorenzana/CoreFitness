    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: 'var(--color-bg)' }}>
      <div className="relative w-full max-w-[375px] h-[812px] rounded-[3rem] overflow-hidden"
        ...
        <div className="relative w-full h-full rounded-[2.8rem] overflow-hidden" style={{ backgroundColor: 'var(--color-bg)' }}>
          ...
          {/* Screen Content */}
          <div id="phone-screen" className="relative h-full flex flex-col" style={{ backgroundColor: 'var(--color-bg)' }}>
            ...
            <div className="relative flex-1 h-full overflow-y-auto pt-8 scrollbar-hide" style={{ backgroundColor: 'var(--color-bg)' }}>
              {children}
            </div>
          </div>
        </div>
